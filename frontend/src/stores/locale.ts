...
const messages = {
  en: {
    ...
    'research.error.bulkDelete': 'Failed to delete selected research tasks',
  ...
  zh: {
    ...
    'chat.placeholderWithResearchContext': '基于当前研究摘要继续追问...',
    'chat.sendHint': '按 Ctrl+Enter 发送',
    'chat.send': '发送',
    'chat.thinking': '思考中...',
    'chat.researchContextActive': '当前已启用研究上下文',
    'chat.clearResearchContext': '清除上下文',
    ...
    'research.selectAll': '全选',
    'research.bulkDelete': '删除所选',
    'research.sort.newest': '最新优先',
    'research.sort.oldest': '最早优先',
    'research.sort.title': '标题 A-Z',
    'research.filter.all': '全部来源',
    'research.filter.arxiv': '仅 arXiv',
    'research.filter.crossref': '仅 Crossref',
    'research.filter.local': '仅本地',
    ...
    'research.error.bulkDelete': '删除所选研究任务失败',
    'research.error.rename': '重命名研究任务失败',
    'research.error.rerun': '重跑研究任务失败',
    'research.error.rerunNew': '另存重跑任务失败',
    'research.failure.title': '研究任务需要处理',
    'research.failure.query': '问题',
    'research.failure.reason': '失败类型',
    'research.failure.retry': '重试上一次失败操作',
    'research.failure.dismiss': '关闭',
  },
} as const
